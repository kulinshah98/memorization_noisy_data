...
def edm_sampler(
    net, latents, class_labels=None, outdir=None, 
...
def main(network_pkl, outdir, subdirs, seeds, class_idx, max_batch_size, 
    ...
    for batch_seeds in tqdm.tqdm(rank_batches, unit='batch', disable=(dist.get_rank() != 0)):
        ...
        images = sampler_fn(net, latents, class_labels, outdir, randn_like=rnd.randn_like, **sampler_kwargs)
